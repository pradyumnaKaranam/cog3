...
if __name__ == '__main__':
	...
	# print "Getting answers/resolution and alternative question"
	# try:
	...
	#project_info = {"project_id":11, "project_tag_id":232 }
	...
	# solr_result = requests.get('http://9.32.165.152:8080/solr/SAPErrors/dataimport?command=full-import')
	# solr_result = requests.get('http://9.32.165.152:8080/solr/SAPErrors/dataimport?command=full-import')
